...
def DisplayForm():
    ...
    display_screen.geometry("1300x400")
    #setting title for window
    display_screen.title("Student Management System")
    global tree
    global SEARCH
    global name,contact,email,rollno,branch, dateofbirth
    SEARCH = StringVar()
    name = StringVar()
    contact = StringVar()
    email = StringVar()
    ...
    #label for heading
    lbl_text = Label(TopViewForm, text="Student Management System", font=('verdana', 18), width=600,bg="light green",fg="white")
